...
<body>
  ...
  <div class="dashboard-container">
    <div class="dashboard-header">
      <span>
        <h2 class="dashboard-title">Nome</h2>
        <h2 class="dashboard-title">Email</h2>
        <h2 class="dashboard-title">Telefone</h2>
        <h2 class="dashboard-title">WhatsApp</h2>
        <h2 class="dashboard-title date-field">Data</h2>
      </span>
    </div>
    <div class="dashboard-items">
      <div class="items-container">
        <?php
        // Incluir o arquivo com a função de consulta ao banco de dados
        ...
        if (!empty($dados)) {
          ...
          foreach ($dados as $row) {
            ...
            echo '<p class="item-info">' . $row['nome'] . '</p>';
            echo '<p class="item-info">
                    <a class="socialContainer mailContainer" href="mailto:' . $row['email'] . '">
            ...
            echo $row['tel'] ? '<p class="item-info">
                                  <a class="socialContainer phoneContainer" href="tel:' . $row['tel'] . '">
                                    <svg width="25px" height="25px" xmlns="http://www.w3.org/2000/svg">
            ...
            echo $row['whatsapp'] ? '<p class="item-info">
                    <a class="socialContainer whatsAppContainer" href="https://api.whatsapp.com/send?phone=' . $row["whatsapp"] . '">
            ...
            echo '<p class="item-info date-field">' . $dateUpdated . '</p>';
            echo '</div>';
          }
        } else {
