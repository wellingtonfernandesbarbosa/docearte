...
const curiositiesButter = document.getElementById('curiositiesButter');
const curiositiesSugar = document.getElementById('curiositiesSugar');
const curiositiesEggs = document.getElementById('curiositiesEggs');
